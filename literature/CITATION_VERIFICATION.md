...
| **Qwen3-1.7B post-trained benchmark scores** — Table 19 (thinking): **MMLU-Redux 73.9**, **GPQA-Diamond 40.1**, C-Eval 68.1, LiveBench 51.1. Table 20 (non-thinking): MMLU-Redux 64.4, GPQA-Diamond 28.6. Qwen eval sampling: thinking "temperature of 0.6, a top-p value of 0.95, and a top-k value of 20"; non-thinking "temperature = 0.7, top-p = 0.8, top-k = 20, and presence penalty = 1.5"; max output 32,768 (38,912 for AIME) | **VERIFIED (primary — arXiv HTML, Tables 19–20)** | `arxiv.org/html/2505.09388v1` |
