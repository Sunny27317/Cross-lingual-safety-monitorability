...
## D-069 — Real-environment smoke finding: llama.cpp v0.4.0 (build b10809) does not expose a parseable default token-count signal; STOP-REASON stays honestly UNKNOWN, not fixed mid-flight
